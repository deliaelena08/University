...
private:
   ...
   // QListWidget* lst = new QListWidget;
    ...
    void loadData(QListView* lst, const vector<Product>& products) {
        ...
        ProductListModel* model = dynamic_cast<ProductListModel*>(lst->model());
        if (!model) {
        ...
        model->setHeaderData(1, Qt::Horizontal, "Tip");
        model->setHeaderData(2, Qt::Horizontal, "Pret");
        model->setHeaderData(3, Qt::Horizontal, "Producator");
