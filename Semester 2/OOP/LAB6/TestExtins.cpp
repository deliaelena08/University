...
void testCauta() {
    cout<<"Test cauta cresc"<<endl;
    testCauta(cresc);
    cout<<"Test cauta desc"<<endl;
    testCauta(desc);
}
...
void testIterator() {
    cout<<"Test iterator crescator"<<endl;
    testIterator(cresc);
    cout<<"Test iterator descrescator"<<endl;
    testIterator(desc);
}
void testAllExtins() {
    cout<<"Test creeaza"<<endl;
    testCreeaza();
    cout<<"Test cauta"<<endl;
    testCauta();
    cout<<"Test sterge"<<endl;
    testSterge();
