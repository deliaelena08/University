...
void actualizareParticipant(char* nume, char* prenume, int scor);

void stergereParticipant(char* nume, char* prenume);

void filtrareValoare(int valoare);

void filtrareLitera(char* litera);
